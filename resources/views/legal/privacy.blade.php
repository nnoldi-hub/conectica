...
@section('title', 'Politica de confidentialitate | Conectica IT')
@section('description', 'Informatii despre prelucrarea datelor personale de catre Conectica IT.')
...
@section('content')
    <main class="mx-auto max-w-4xl px-6 py-20 lg:px-8 lg:py-28">
        ...
        <h1 class="mt-5 text-4xl font-semibold tracking-tight text-slate-900 sm:text-6xl">Politica de confidentialitate</h1>
        <div class="mt-10 space-y-8 text-lg leading-8 text-slate-600">
            ...
            <section>
                <h2 class="text-2xl font-semibold text-slate-900">De ce folosim datele</h2>
                <p class="mt-3">Datele sunt folosite pentru a raspunde solicitarilor, a clarifica cerintele proiectului si a comunica despre serviciile solicitate. Nu vindem si nu inchiriem datele personale.</p>
            </section>
            <section>
