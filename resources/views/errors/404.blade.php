...
<head>
    ...
    <title>Pagina nu a fost gasita | Conectica IT</title>
...
<body>
    <div class="card">
        ...
        <p class="code">Eroare 404</p>
        <h1>Pagina nu a fost gasita.</h1>
        <p>Ne pare rau, pagina pe care o cauti nu exista sau a fost mutata. Verifica adresa sau reia navigarea de pe pagina principala.</p>
        <div class="actions">
            <a href="{{ url('/') }}" class="btn btn-primary">Inapoi la pagina principala</a>
            <a href="{{ url('/contact') }}" class="btn btn-secondary">Contacteaza-ne</a>
        </div>
    </div>
</body>
</html>
