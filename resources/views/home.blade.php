...
@section('content')
        <main>
            <section class="mx-auto grid max-w-7xl gap-16 px-6 pb-24 pt-24 lg:grid-cols-[1.15fr_.85fr] lg:px-8 lg:pb-32 lg:pt-32">
                <div class="flex flex-col justify-center">
                    ...
                    <div class="mt-10 flex flex-wrap gap-4">
                        <a href="{{ route('services.index') }}" class="rounded-full bg-cyan-400 px-6 py-3 font-semibold text-slate-950 transition hover:bg-cyan-300">
                            Descopera serviciile
                        </a>
                        <a href="{{ route('contact.create') }}" class="rounded-full border border-white/20 px-6 py-3 font-semibold text-white transition hover:border-white/50">
                ...
                <div class="relative flex items-center justify-center">
                    ...
                    <div class="relative w-full max-w-md rounded-3xl border border-white/10 bg-white/[0.06] p-8 shadow-2xl shadow-cyan-950/40">
                        <div class="mb-12 flex items-center justify-between text-xs uppercase tracking-[0.2em] text-slate-400">
